                ...
                for (int k = 0; k < MainWindow.eLC.Lists[9].elementFields.Length; k++)
                {
                    ...
                    if (MainWindow.eLC.Lists[9].elementFields[k] == "fixed_props")
                    {
                        if ("0" == MainWindow.eLC.GetValue(9, pos_item, k))
                        {
                            ...
                            {
                                if (MainWindow.eLC.Lists[9].elementFields[t] == "probability_addon_num" + nu)
                                {

                                    probability_addon_numX[nu] = MainWindow.eLC.GetValue(9, pos_item, t);
                                    nu++;
                                    if (nu == 5) { break; }
                                }
                            }
                        ...
                        else if ("0" != MainWindow.eLC.GetValue(9, pos_item, k))
                        {
